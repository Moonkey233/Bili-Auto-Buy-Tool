...
#变化值
buy_num = 1 #设置购买秒杀套数1-100
uid_bili = "215177187" #设置购买用户UID, 目前就显示用
expectation = 723 #设置预期抢购的编号
final_num = 0 #设置最终区间 1314 2 即代表播报1311触发最后连号
item_id = 39879 #设置监听装扮id, 断网或抓包获得网址后网页调试获得
fresh_sec = 0.15 #设置刷新的间隔
...
version = "6.77.0" #抓包版本号
eid = "U1UER1YDB1kA" #有时效的用户登录验证, 抓包
csrf = "2e5dc370101b3d2f1b8742c548da0fb4" #有时效的用户登录验证, 抓包
access_key = "3428bc57e9c7724dd9abf7e7e355b8b2" #有时效的用户登录验证, 抓包
cookies = { #有时效的用户登录验证, 抓包
    "SESSDATA":"b189e6f5%2C1683252548%2Ccd2449b2",
    "DedeUserID__ckMd5":"db23a7f040ba3d37",
    "sid":"5wszmvdf",
...
#有时效的用户登录验证, 抓包
agent = "Mozilla/5.0 (Linux; Android 12; Mi 10 Pro Build/SKQ1.220303.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 os/android model/Mi 10 Pro build/6770300 osVer/12 sdkInt/31 network/2 BiliApp/6770300 mobi_app/android channel/alifenfa Buvid/XX57096569BE10B097E4EFB36850197D6460A sessionID/6ab4c208 innerVer/6770300 c_locale/zh_CN s_locale/zh_CN disable_rcmd/0 6.77.0 os/android model/Mi 10 Pro mobi_app/android build/6770300 channel/alifenfa innerVer/6770300 osVer/12 network/2"
# api_cookie = r'''buvid3=DD8E0EC3-967C-4EF3-4F5E-B558D04E58F590800infoc; i-wanna-go-back=-1; _uuid=B8B13A7A-484E-56210-9424-8D612EC7C610F90546infoc; buvid4=5623165E-DE74-A540-1E29-D808F1F3311F92240-022031500-pOTnPn1mSLHM7gp0IvFWYg==; buvid_fp_plain=undefined; buvid_fp=12ec06c99d3813205d1bd6fc4978b706; rpdid=|(J~JY|YuRY~0J'uYR~k~lkYY; CURRENT_BLACKGAP=0; LIVE_BUVID=AUTO5516474282866283; nostalgia_conf=-1; blackside_state=0; hit-dyn-v2=1; CURRENT_QUALITY=120; is-2022-channel=1; b_nut=100; fingerprint3=3f1b7a30861b19380f9fd5561f012e65; b_ut=5; bp_video_offset_1709355263=708216085546008700; bp_article_offset_1709355263=708203625829105700; fingerprint=90a494eed3ffb59484e29540b5400ab5; PVID=2; DedeUserID=215177187; DedeUserID__ckMd5=db23a7f040ba3d37; CURRENT_FNVAL=4048; SESSDATA=42a731ff,1679747461,c969f*91; bili_jct=e039e1ce0db64a96449f8b2f84f0e345; sid=6m3b02fi'''
...
time_headers = { #app开屏抓包获取时间戳
    ...
    "env": "prod",
    "app-key": "android64",
    "user-agent": "Mozilla/5.0 BiliDroid/7.0.0 (bbcallen@gmail.com) os/android model/Mi 10 mobi_app/android build/7000400 channel/xiaomi innerVer/7000410 osVer/12 network/2",
...
def suitPost(n):
    ...
    headers = {
        ...
        "referer":f"https://www.bilibili.com/h5/mall/suit/detail?id={item_id}&navhide=1&f_source=shop&from=icon.category&from_id=",
