...
#变化值
predict_time = 0.03 #负数提前, 正数延后, 单位: 秒
buy_num = 1 #购买套数m 建议大前期号为1, 至多2
item_id = 38286 #购买装扮id
# item_id = 32296 #test
uid = "215177187" #购买者uid
buy_time = 1664017200 #装扮开售标准时间
# buy_time = int(time.time() + 12)
version = "7.0.0" #抓包版本号
eid = "U1UER1YDB1kA" #有时效的用户登录验证, 抓包
csrf = "394b1950bae48685408c4eb0bc1813b7" #有时效的用户登录验证, 抓包
access_key = "5b8363a319bb62896fa203e4b2e78f91" #有时效的用户登录验证, 抓包
cookies = { #有时效的用户登录验证, 抓包
    "SESSDATA":"e83b09da%2C1679497610%2Ce5dcda91",
...
time_headers = { #app开屏抓包获取时间戳
    ...
    "env": "prod",
    "app-key": "android64",
    "user-agent": "Mozilla/5.0 BiliDroid/7.0.0 (bbcallen@gmail.com) os/android model/Mi 10 Pro mobi_app/android build/7000400 channel/xiaomi innerVer/7000410 osVer/12 network/2",
