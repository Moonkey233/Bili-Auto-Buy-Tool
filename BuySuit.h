...
public:
	...
	BuySuit(string bn = "1", string am = "-1", string ct = "", string fs = "shop", string from = "feed.card", string st = "2022:10:01 19:00:00", string mp = "./message.txt", bool isSplit = false, int pt = 0);
	~BuySuit();
	int post();
	int setTimer();
	int setMethod();
...
private:
	...
	const string _host = "api.bilibili.com";
